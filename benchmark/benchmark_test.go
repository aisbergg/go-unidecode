...
import (
	...
	aisbergg "github.com/aisbergg/go-unidecode/pkg/unidecode"
	fiam "github.com/fiam/gounidecode/unidecode"
...
var (
	...
	english  = `But there is something that I must say to my people, who stand on the warm threshold which leads into the palace of justice: In the process of gaining our rightful place, we must not be guilty of wrongful deeds. Let us not seek to satisfy our thirst for freedom by drinking from the cup of bitterness and hatred. We must forever conduct our struggle on the high plane of dignity and discipline. We must not allow our creative protest to degenerate into physical violence. Again and again, we must rise to the majestic heights of meeting physical force with soul force.`
	japanese = `江戸時代末期、「天人（あまんと）」と呼ばれる宇宙人達が襲来した。まもなく地球人と天人との間に十数年にも及ぶ攘夷戦争が勃発。数多くの侍・攘夷志士が天人との戦争に参加した。しかし天人の絶大な力を見て弱腰になっていた幕府は、天人の侵略をあっさりと受け入れ開国してしまう。そして幕府は天人による傀儡政権となり、天人達が我が物顔で江戸の街を闊歩するようになった。一方、国・主君のために天人と戦った攘夷志士達は弾圧の対象となり、他の侍達もその多くが廃刀令によって刀を失い、力を奪われていった。
...
func init() {
	...
	sb.Grow(len(chinese) + len(english) + len(japanese))
	sb.WriteString(chinese)
